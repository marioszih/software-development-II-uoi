...
public class LatexEditorController{
	...
	//private String[] cmds = new String[] {"addLatex","changeVersionsStrategy","create","disableVersionsManagement"
	...
	public LatexEditorController(VersionsManager versionsManager) {
		...
		/*for(int i=0;i<cmds.length;i++) {
			commands.put(cmds[i], commandFactory.createCommand(cmds[i]));
		}*/
